...
export default function Projects() {
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-center text-white overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-[#0a0f1f] via-black to-[#1a1033]" />
      ...
      <motion.div
        ...
        bg-[linear-gradient(90deg,rgba(255,255,255,0.2)_1px,transparent_1px),linear-gradient(rgba(255,255,255,0.2)_1px,transparent_1px)]
        bg-[size:60px_60px]"
      />
      ...
      <Swiper
        ...
        className="w-full px-6 lg:px-16 z-10"
      >
        {projects.map((p, idx) => (
          <SwiperSlide key={idx}>
            <motion.div
              ...
              className="rounded-xl p-6 bg-gradient-to-br from-[#2e2e2e] to-[#1c1c1c] 
                         shadow-[inset_1px_1px_3px_rgba(255,255,255,0.1),inset_-2px_-2px_6px_rgba(0,0,0,0.6)]
            ...
            >
              ...
              <div className="flex flex-wrap gap-2 mt-3">
                {p.tech.map((t, i) => (
                  <span
                    key={i}
                    className="text-xs bg-white/5 px-2 py-1 rounded-md text-gray-200 border border-white/10"
                  >
                    {t}
                  </span>
                ))}
